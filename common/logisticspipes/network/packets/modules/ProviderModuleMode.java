...
public class ProviderModuleMode extends IntegerCoordinatesPacket {
	...
	public void processPacket(EntityPlayer player) {
		if (FMLClientHandler.instance().getClient().currentScreen instanceof GuiProvider) {
			((GuiProvider) FMLClientHandler.instance().getClient().currentScreen).handleModuleModeRecive(getInteger());
		}
	}
}
